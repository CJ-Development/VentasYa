  ...
  return (
    <div className="legal-page">
      <div className="legal-container">
        ...
        <h1>Términos y Condiciones de Baúl Mágico Shop</h1>
        ...
        <div className="legal-content">
          <section className="legal-section">
            ...
            <p>
              Al acceder y utilizar Baúl Mágico Shop, usted acepta estos Términos y Condiciones. 
          ...
          <section className="legal-section">
            ...
            <p>
              Baúl Mágico Shop es una plataforma de comercio electrónico que permite a los usuarios 
          ...
          <section className="legal-section">
            ...
            <p>
              Las políticas de devolución son establecidas por cada vendedor. Baúl Mágico Shop actúa 
          ...
          <section className="legal-section">
            ...
            <p>
              Todo el contenido de Baúl Mágico Shop (imágenes, textos, logotipos, diseño) está protegido 
          ...
          <section className="legal-section">
            ...
            <p>
              Baúl Mágico Shop no se hace responsable por:
            </p>
            <ul>
          ...
          <section className="legal-section">
            ...
            <p className="legal-contact">
              <strong>Email:</strong> soporte@baulmagicoshop.com<br />
              <strong>Sitio web:</strong> https://baulmagicoshop.com
            </p>
          </section>
        </div>
