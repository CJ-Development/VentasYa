...
function ProductPreview({ productId, onClose }) {
        ...
        return (
            ...
            <div className="preview-overlay">
                ...
                <div className="preview-container">
                    ...
                    <div className="preview-loading">Cargando vista previa...</div>
        ...
        return (
            ...
            <div className="preview-overlay">
                ...
                <div className="preview-container">
                    ...
                    <div className="preview-empty">{error || "Producto no encontrado."}</div>
    ...
    const imagenPrincipal = todasImagenes[0]?.imagen || NoImage;

    const coloresUnicos = Array.from(

        new Map((producto.variantes || []).map((v) => [v.color?.id_color, v.color])).values()

    ).filter(Boolean);

    const tallasUnicas = Array.from(

        new Map((producto.variantes || []).map((v) => [v.talla?.id_talla, v.talla])).values()

    ).filter(Boolean);

    const precioFmt = `$${Number(producto.precio).toLocaleString("es-CO")}`;
            ...
            <div className="preview-container">
                ...
                <div className="preview-header">
                    ...
                    <div>
                        ...
                        <span className="preview-preview-tag">SOLO PREVIEW</span>
                    ...
                    <section className="product-container">
                        ...
                        <section className="product-info">
                            ...
                            <span className="product-category">
                                ...
                                {(producto.categoria?.nombre || "PRODUCTO").toUpperCase()}
                            ...
                            <div className="product-price">{precioFmt}</div>
                                ...
                                <>
                                    ...
                                    <div className="sizes">
                                        ...
                                        {tallasUnicas.map((t) => (
                                            ...
                                            <button key={t.id_talla} type="button">
