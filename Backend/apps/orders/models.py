...
class Compra(models.Model):
    ...
    usuario = models.ForeignKey("users.Usuario", on_delete=models.PROTECT, db_column="id_usuario", related_name="compras")
    direccion = models.ForeignKey("users.Direccion", on_delete=models.PROTECT, db_column="id_direccion")
...
class DetalleCompra(models.Model):
    ...
    size_variant = models.ForeignKey("products.SizeVariant", on_delete=models.PROTECT, db_column="id_size_variant")
